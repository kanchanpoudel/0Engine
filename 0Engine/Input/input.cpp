...
namespace s00nya
{
		...
		m_keyMaps
	{
		...
		{ Keys::KEY_A, InputState::UP },
		{ Keys::KEY_B, InputState::UP },
		{ Keys::KEY_C, InputState::UP },
		{ Keys::KEY_D, InputState::UP },
		{ Keys::KEY_E, InputState::UP },
		{ Keys::KEY_F, InputState::UP },
		{ Keys::KEY_G, InputState::UP },
		{ Keys::KEY_H, InputState::UP },
		{ Keys::KEY_I, InputState::UP },
		{ Keys::KEY_J, InputState::UP },
		{ Keys::KEY_K, InputState::UP },
		{ Keys::KEY_L, InputState::UP },
		{ Keys::KEY_M, InputState::UP },
		{ Keys::KEY_N, InputState::UP },
		{ Keys::KEY_O, InputState::UP },
		{ Keys::KEY_P, InputState::UP },
		{ Keys::KEY_Q, InputState::UP },
		{ Keys::KEY_R, InputState::UP },
		{ Keys::KEY_S, InputState::UP },
		{ Keys::KEY_T, InputState::UP },
		{ Keys::KEY_U, InputState::UP },
		{ Keys::KEY_V, InputState::UP },
		{ Keys::KEY_W, InputState::UP },
		{ Keys::KEY_X, InputState::UP },
		{ Keys::KEY_Y, InputState::UP },
		{ Keys::KEY_Z, InputState::UP },

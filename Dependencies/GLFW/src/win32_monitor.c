                                   ...
                                   DISPLAY_DEVICEW* display)
{
    ...
    wcscpy_s(monitor->win32.adapterName, sizeof(monitor->win32.adapterName), adapter->DeviceName);
    ...
    if (display)
    {
        wcscpy_s(monitor->win32.displayName, sizeof(monitor->win32.displayName),display->DeviceName);
        WideCharToMultiByte(CP_UTF8, 0,
